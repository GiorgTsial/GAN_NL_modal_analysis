...
file_name = "3_DOF_nonlinear_disps.csv"
...
for epoch in range(7000, 7000 + 1, 100):
    ...
    print("\n")
    encoder_path = os.path.join(os.getcwd(), "checkpoints", "cycleGAN_checkpoints_3DOF_nonlinear", "g_model_AtoB_" + str(epoch) + ".h5")
...
file_name = "3_DOF_nonlinear_disps_test_dataset.csv"
file_path = os.path.join(os.getcwd(), 'data', file_name)
...
file_name = "3_DOF_nonlinear_disps_linear_modal.csv"
file_path = os.path.join(os.getcwd(), 'data', file_name)
...
decoder_path = os.path.join(os.getcwd(), "checkpoints", "cycleGAN_checkpoints_3DOF_nonlinear", "g_model_BtoA_" + str(best_epoch) + ".h5")
