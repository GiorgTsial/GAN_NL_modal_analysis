...
def main():
    ...
    for epoch in range(0, 10000 + 1, 100):
        ...
        if os.path.isfile(encoder_path):
            ...
            freqs, frf1 = signal.welch(encoded_disps[:, 0], sampling_freq, noverlap=0, nperseg=NPERSEG/2)
            freqs, frf2 = signal.welch(encoded_disps[:, 1], sampling_freq, noverlap=0, nperseg=NPERSEG/2)
            freqs, frf3 = signal.welch(encoded_disps[:, 2], sampling_freq, noverlap=0, nperseg=NPERSEG/2)
            frfs = [frf1, frf2, frf3]
